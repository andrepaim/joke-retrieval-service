...
class JokeClient:
    ...
    def record_feedback(self, joke_id: str, liked: bool, feedback_text: str = None) -> None:
        """
    ...
    def add_joke(self, text: str, category: str, tags: list, source: str = None) -> None:
        """
...
def main():
    ...
    multi_parser.add_argument("--max", type=int, default=3, help="Maximum number of jokes to return")
    
    # Record feedback command
    feedback_parser = subparsers.add_parser("feedback", help="Record feedback for a joke")
    feedback_parser.add_argument("joke_id", help="Joke ID")
    feedback_parser.add_argument("--liked", action="store_true", help="Whether the joke was liked")
