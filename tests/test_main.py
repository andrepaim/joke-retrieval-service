...
with patch("app.main.start_mcp_server") as mock_mcp_server, patch(
    "app.main.start_grpc_server"
) as mock_grpc_server, patch(
    "app.main.setup_vector_extension"
) as mock_vector_setup, patch(
    "app.main.Base"
) as mock_base, patch(
    "app.main.os.system"
) as mock_os_system, patch(
    "app.main.os.path.exists", return_value=True
):
    # Import app after mocks
    from app.main import generate_proto, init_database, start_server
...
class TestMain(unittest.TestCase):
    ...
    def test_init_database(
        self, mock_base, mock_vector_setup, mock_grpc_server, mock_mcp_server
    ):
